                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-auto">
                                <div class="d-flex flex-wrap align-items-start gap-2">
                                    <a href="{{ url('/experience-create') }}" class="btn btn-primary add-btn"  id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Add Experience</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table align-middle" id="customerTable">
                                    <thead class="table-light text-muted">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="customer_name">Working Title</th>
                                            <th class="sort" data-sort="email">From date</th>
                                            <th class="sort" data-sort="phone">To Date</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email">{{ $item->from_date }}</td>
                                            <td class="phone">{{ $item->to_date }}</td>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                    <li class="list-inline-item edit"  title="Edit">
                                                        <a href="{{ url('/edit-experience',$item->id)}}" class="text-primary d-inline-block edit-item-btn">
                                                            <i class="ri-pencil-fill fs-16"></i>
                                                        </a>
                                                    </li>
                                                    <li class="list-inline-item" title="Remove">
                                                        <a class="text-danger d-inline-block remove-item-btn" href="{{ url('/delete-experience',$item->id)}}">
