...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="{{ url("/update-experience",$ex_item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ $ex_item->title }}" required />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <label for="job-title-Input" class="form-label">From Date <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="from_date" value="{{ $ex_item->from_date }}" required />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <label for="job-title-Input" class="form-label">To Date <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="to_date" value="{{ $ex_item->to_date }}" required />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div>
                                        <label for="job-title-Input" class="form-label">Description <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="description" value="{{ $ex_item->description }}" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div>
                                        <label for="start-salary-Input" class="form-label">responsibility</label>
                                        <input type="text" class="form-control" name="responsibility" value="{{ $ex_item->responsibility }}" required />
                                    </div>
                                </div>
                                <div class="col-lg-12">
