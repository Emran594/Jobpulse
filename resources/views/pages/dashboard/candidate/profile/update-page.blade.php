...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="{{ url("/info-update",['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input type="file" class="form-control" name="image" id="country-Input" value="{{ $data->image }}" required />
                                    </div>
                                </div>
                                <div class="col-lg-12">
